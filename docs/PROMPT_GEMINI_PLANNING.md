...
Recentemente migrei a calculadora de dropshipping que rodava em `http://localhost:5173/__calc/` para dentro do meu sistema principal em `http://localhost:3001/pt-br` movendo os arquivos para dentro do diretório `src/`. 
