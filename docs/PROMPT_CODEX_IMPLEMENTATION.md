...
1. **Documento de Planejamento** gerado pelo Google Gemini Pro 3 que está no chat
...
```markdown
1. [ ] Ler completamente o documento de planejamento do Gemini
2. [ ] Identificar a estratégia de correção recomendada (Opção A, B, C ou D)
3. [ ] Listar todos os arquivos que precisam ser modificados
4. [ ] Confirmar comigo se entendeu o plano antes de começar
```
...
#### Iteração 1: Isolamento Básico
```typescript
// Exemplo: Criar wrapper com namespace
// src/features/calculator/Calculator.tsx

import { ThemeProvider, createTheme } from '@mui/material/styles';
import CssBaseline from '@mui/material/CssBaseline';
import './calculator.scoped.css'; // CSS isolado

const calculatorTheme = createTheme({
  // Configuração de tema isolada
});

export function Calculator() {
  return (
    <div className="calculator-root"> {/* Namespace CSS */}
      <ThemeProvider theme={calculatorTheme}>
        <CssBaseline /> {/* Reset isolado */}
...
**TESTE**: Verifique se o isolamento funcionou antes de prosseguir.
...
**TESTE**: Layout deve ser 50/50 em desktop, 100% em mobile.
...
1. ✅ Cards têm bordas visíveis (compare com screenshot correto)
2. ✅ Inputs têm largura controlada (não 100% width)
3. ✅ Espaçamento consistente entre elementos
4. ✅ Layout em grid funcional (2 colunas em desktop)
5. ✅ Cores e contrastes preservados
6. ✅ Nenhum erro no console
7. ✅ Nenhuma regressão em outras páginas do sistema
8. ✅ Código documentado e limpo
